                        ...
                        FROM (
                            ...
                            FROM (
                                ...
                                FROM (
                                    SELECT code, name, date, price
                                    FROM etf.ads_etf_strategy_history_rpt
                                    WHERE code IN ('517180', '159637', '515880', '159636', '159941', '513300', '515000', '512480', '588200', '159790', '159995', '515080', '159997', '159870', '512710', '159639', '518880', '512890', '159869', '159875', '159632', '513120', '512500', '159994', '159647', '159939', '159801', '560090', '159820', '159601', '516160', '159806', '159922', '159516', '159845')
                                        AND date >= '2015-07-13'
                                        AND date IN (
                                            SELECT date
